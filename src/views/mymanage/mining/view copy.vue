<template>
  <div class="home-container">
    <div class="accountsinfo-container">
      ...
      <div class="content-container" v-if="address" v-show="showTable">
        <div calss="content-wrapper">
          <div class="top-wrapper">
            <div class="left-wrapper">
              <span :class="'is_activity'">{{
                $t("mymanageNode.candidateNode")
              }}</span>
              <span>{{ $t("mymanageNode.witnessNode") }}</span>
            </div>
          </div>
...
export default {
  components: { fTable, fElrow, logtable },
  data() {
    return {
      showTable: false,
      address: "",
      ...
      titles: [
        {
          titles: [
            ...
            // { title: "mymanageMining.lockamount" },
