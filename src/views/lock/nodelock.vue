      ...
      <div class="block-container">
        <div class="content-wrapper">
          ...
          <div
            ...
            @click="getFlowlockList(page + 1, 1)"
          >
            {{ loadText }}
          </div>
        </div>
...
export default {
  ...
  methods: {
     toviews(data) {
      if (data.address) {
        helper.goPathUrl(this, "nodeView", `${data.address}_1`);
      }
    },
    toRelease(data) {
          ...
          if (response.statusCode !== 0) {
            ...
            data.forEach((item, index) => {
              ...
              let temp = {
                ...
                state,
                /* leftAmount:
                  helper.getDataFormat(item.leftAmount, 18, 10000).toFixed(4) +
                  " NFC",*/
